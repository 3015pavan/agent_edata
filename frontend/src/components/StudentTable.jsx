  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div className="border-b border-slate-200 px-4 py-4">
        ...
        <p className="mt-1 text-sm text-slate-500">{students.length} student record(s) in the current view.</p>
      </div>
          ...
          <tbody className="divide-y divide-slate-100">
            ...
            {students.map((student) => (
              <tr key={student.usn} className="align-top">
                ...
                <td className="px-4 py-4 text-sm text-slate-700">{student.sgpa.toFixed(2)}</td>
